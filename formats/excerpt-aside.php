...
<?php if ( get_theme_mod( 'gb_aside_title') == '1' ) { ?>
...
<?php } else { ?>
	<div class="post-content">
	<a href="<?php echo get_permalink(); ?>"><span class="dashicons dashicons-format-aside notitle"></span></a>
<?php } ?>

<?php
	if ( get_theme_mod( 'gb_aside_excerpt' ) == '1' ) {
		the_excerpt();
			} else {
		the_content();
	}
